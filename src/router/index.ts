    ...
    // ── Partner / Gym portal ────────────────────────────────────
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { requiresPermission: 'gym.facility.view' },
        },
        {
          path: 'team',
          name: 'partner-team',
          component: () => import('../views/partner/GymTeamView.vue'),
          meta: { requiresPermission: 'gym.team.view' },
        },
        {
          path: 'settings',
    ...
    // ── Company HR portal ────────────────────────────────────────
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { requiresPermission: 'co.employees.register' },
        },
        {
          path: 'employees',
          name: 'hr-employees',
        ...
        },
        {
          ...
          meta: { requiresPermission: 'co.team.view' },
        },
        {
          path: 'settings',
          name: 'hr-settings',
    ...
    // ── Admin panel ─────────────────────────────────────────────
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { requiresPermission: 'memberships.view' },
        },
        {
          path: 'attendance',
        ...
        },
        {
          ...
          meta: { requiresPermission: 'payment_methods.view' },
        },
        {
          path: 'team',
          name: 'admin-team',
          component: () => import('../views/admin/AdminTeamView.vue'),
          meta: { requiresPermission: 'team.view' },
        },
        {
          path: 'permissions',
        ...
        },
        {
          ...
          meta: { requiresPermission: 'employee_approvals.view' },
        },
        {
          path: 'settings',
          name: 'admin-settings',
