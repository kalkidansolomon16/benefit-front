...
.input.input-error { border-color: #e0386a; box-shadow: 0 0 0 3px rgba(224,56,106,0.08); }
...
.upload-zone-error { border-color: #e0386a; background: #fff8f9; }
...
.preview-remove:hover { background: #e0386a; }
