...
const navItems = computed(() => {
  const all = [
    ...
    {
      name: 'roles', label: 'Custom Roles', to: '/admin/roles',
      permission: 'permissions.manage',
      icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/><line x1="12" y1="16" x2="12" y2="21"/><line x1="9" y1="19" x2="15" y2="19"/></svg>`,
    },
    {
...
const pageMeta: Record<string, { title: string; sub?: string }> = {
  ...
  'admin-roles':              { title: 'Custom Roles', sub: 'Add custom roles for specific companies or gyms' },
