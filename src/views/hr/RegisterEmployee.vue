        ...
        <div class="field">
          ...
          <div class="date-wrap">
            <input
              ...
              type="date"
              class="input input-full date-input-styled"
            />
            <svg
              class="date-icon"
              width="15"
        ...
        >
          ...
          <template v-else>
            ...
            >
              ...
              <path
                d="M20.45 5.65A2 2 0 0 0 18.5 4H5.5a2 2 0 0 0-1.95 1.65L3 7H1v2h1l-1 10a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2L22 9h1V7h-2l-.55-1.35z"
              />
            </svg>
...
function validate() {
  ...
  else if (form.fan_number.length !== 13)
    errors.fan_number = 'FAN number must be exactly 13 digits.'
